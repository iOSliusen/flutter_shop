...
import 'package:flutter_shop/Business/Login/ViewModel/LoginViewModel.dart';
import 'package:provider/provider.dart';
import 'package:flutter_shop/Route/RoutePaths.dart';
...
class _LoginViewState extends State<LoginView> {
  ...
  Widget build(BuildContext context) {
    return LSBaseView<LoginViewModel>(
